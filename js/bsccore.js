...
const LPTokenAddress = '0xbe759bE1D8ef5cf84D7cdA3E5e6D5c3e9C72656A';
...
async function loadTVaultData() {
  ...
  var pendingBsc = await vault.methods.pendingBsc('1', address).call();
  ...
  var amountStaked = (await vault.methods.userInfo('1', address).call()).amount;
...
async function claimLPV1() {
  ...
  const claim = await new Promise((resolve, reject) => {
    vault.methods.deposit('1', '1').send(
      {
        from: address,
      },
      function (error, transactionHash) {
...
async function withdrawAllLPV1() {
  ...
  const withdraw = await new Promise((resolve, reject) => {
    vault.methods.withdraw('1', amountStaked).send(
      {
        from: address,
      },
      function (error, transactionHash) {
...
async function loadTVaultV2Data() {
  ...
  var amountStaked = (await vault.methods.userInfo('1', address).call()).amount;
  document.getElementById('stakedLP').innerHTML = Number(
    web3.utils.fromWei(amountStaked, 'ether')
  ).toFixed(5);
...
async function stakeAllLPV2() {
  ...
  const deposit = await new Promise((resolve, reject) => {
    vault.methods.depositAll('1').send(
      {
        from: address,
      },
      function (error, transactionHash) {
...
async function withdrawAllLPV2() {
  ...
  const withdraw = await new Promise((resolve, reject) => {
    vault.methods.withdrawAll('1').send(
      {
        from: address,
      },
      function (error, transactionHash) {
